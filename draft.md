...
- the study only suggest work engagement **relate**, the cross-sectional study did not allow authors to examine the causation of these variables
- using longitudinal -> change the design, what cause engagement vs workaholism
- work engagement: a state of happy -> more productive
  - what if more productive -> work engeagement
- workaholic -> conflict, not satify
  - what if not satisfy with salary, conflict with worker -> workaholism
  - more work home inference -> workaholism
- a bad day -> it gonna worse -> find research for this

- burnout and amotivation: what is amotivation according to SDT

**basic psychological needs** that may be either satisfied or frustrated,
SDT revolve around the proposition that processes of active development and organization require specific nutrients from the social environment.
set of basic psychological needs that may be either satisfied or frustrated
Need-­supportive environment facilitate the development of integrated self-­regulatn
, including capaties to manage the multiple drives, impulses, emotions, and motives that arise within
every individual (e.g., Bindman, et al. 2015; Di Domenico et al., 2013). If basic needs are thwarted,
